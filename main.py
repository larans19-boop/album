...
capitao_america = cadastrar_personagem(filme=vingadores, nome="Capitão América")
...
fig3=cadastrar_figurinha(filme=vingadores, numero=3, personagem=capitao_america)
...
fig6=cadastrar_figurinha(filme=vingadores, numero=5, personagem=hardy)
